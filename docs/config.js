// Configuration MathQuiz - Production v2
const CONFIG = {
...
// Realtime Connection Manager (Supabase Realtime)
class RealtimeManager {
    ...
    subscribeToQuizEvents() {
        ...
        console.log('🎮 Subscribed to quiz events');
    }
    ...
    handleQuizEvent(event) {
        console.log('📨 Quiz event received:', event.event_type);
    ...
    async send(data) {
        ...
        try {
            ...
            if (error) {
                ...
                console.log('📤 Realtime event sent:', data.type);
            }
...
if (typeof window !== 'undefined') {
    ...
    console.log('🔗 Realtime System: Supabase Realtime');
}